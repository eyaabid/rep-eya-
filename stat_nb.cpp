...
void stat_nb::stats()
{
    ...
    q2.prepare("SELECT * FROM EMPLOYEE WHERE age >=0 and age <=25");
    q2.exec();

    q3.prepare("SELECT * FROM EMPLOYEE WHERE age >=26 and age<=75");
    q3.exec();

    q4.prepare("SELECT * FROM EMPLOYEE WHERE age >=76 ");
    q4.exec();
